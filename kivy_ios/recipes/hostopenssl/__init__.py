...
arch_mapper = {"x86_64": "darwin64-x86_64-cc", "arm64": "darwin64-arm64-cc"}
...
class HostOpensslRecipe(HostRecipe):
    ...
    def build_platform(self, plat):
        ...
        shprint(configure, arch_mapper[plat.arch], _env=build_env)
